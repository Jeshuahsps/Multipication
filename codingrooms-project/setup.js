...
function getStats() {
    ...
    if (Number.isInteger(parseInt(minInput.value)) && Number.isInteger(parseInt(maxInput.value)) && Number.isInteger(parseInt(queInput.value)) && parseInt(minInput.value) < parseInt(maxInput.value)) {
